...
#define	configQUEUE_SEND_TASK_PRIORITY		( tskIDLE_PRIORITY + 3 )
...
TickType_t xSendBlockTime1 = ( 100UL / portTICK_PERIOD_MS );
...
{      
  prvConfigureLCD();
	...
	xTaskCreate( prvQueueSendTask, "TX", configMINIMAL_STACK_SIZE, NULL, configQUEUE_SEND_TASK_PRIORITY, NULL );
       // xTaskCreate( vTaskFunction, "Test", configMINIMAL_STACK_SIZE, NULL, configQUEUE_SEND_TASK_PRIORITY-2, NULL );
...
const unsigned long ulValueToSend = mainQUEUED_VALUE;
  static char cBuffer[ 512 ];
	...
	for( ;; )
	{
		...
		xSemaphoreTake( xTxSemaphore, xSendBlockTime1 );
