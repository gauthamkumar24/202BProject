...
#define ARM_MATH_CM3
        /*1-Performace
          ...
          3-OnDemand
          4-PAST_MIX_FREQ*/
#define configPERFORMANCE_SCALING_MODE                  3
#define configPERFORMANCE_SCALING                       1
#define CPU_USAGE_MIN                                   45
#define CPU_USAGE_MAX                                   55
...
//configure the runtime stats initialisation here
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS() vConfigureTimerForRunTimeStats()
// get cpu run time fron read tiner 11 values for counter and overflow
#define portALT_GET_RUN_TIME_COUNTER_VALUE( ulCountValue )									\
	{																						\
		TIM_Cmd( TIM11, DISABLE );															\
		ulCountValue = ( ( ulTIM6_OverflowCount << 16UL ) | ( unsigned long ) TIM11->CNT );	\
