...
//#define mainCHECK_CPUUSAGE_TIMER_PERIOD_MS      ( 5000UL / portTICK_PERIOD_MS )
//#define mainTASK_TIMER_PERIOD_MS                ( 5000UL / portTICK_PERIOD_MS )
#define mainCHECK_CPUUSAGE_TIMER_PERIOD_MS      ( 5000UL )
#define mainTASK_TIMER_PERIOD_MS                ( 5000UL )
/*-----------------------------------------------------------*/

/*
* The check timer callback function, as described at the top of this file.
*/
static void prvCheckCpuUsageCallback( TimerHandle_t xTimer );
//void prvCheckUsageCallback( void );
/*
...
void main_full( void )
{
    ...
    xCheckTimer = xTimerCreate( "UsageCheckTimer",					/* A text name, purely to help debugging. */
    ( mainCHECK_CPUUSAGE_TIMER_PERIOD_MS ),	/* The timer period, in this case 3000ms (3s). */
    pdTRUE,							/* This is an auto-reload timer, so xAutoReload is set to pdTRUE. */
    ( void * ) 0,					/* The ID is not used, so can be set to anything. */
    prvCheckCpuUsageCallback			/* The callback function that inspects the status of all the other tasks. */
    );
   ...
   // xTaskCreate( CheckUsage, "CPU", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 5, NULL );
    xTaskCreate( Task1_Handler, "HIGH", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 1, NULL );
    xTaskCreate( Task2_Handler, "MID",  configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2, NULL );
    xTaskCreate( Task3_Handler, "LOW",  configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 3, NULL );
...
{   static char cBuffer[ 512 ];
    ...
    for(;;)
    {
       vTaskDelay( mainTASK_TIMER_PERIOD_MS ); 
      j++;
