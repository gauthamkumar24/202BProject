...
@verbatim
 ...
 ===============================================================================
    ...
    [..] It is recommended to use the following software sequences to tune the
         number of wait states needed to access the Flash memory with the CPU   //gautham
         frequency (HCLK).
...
/**
  ...
  *           configuration based on this function will be incorrect.//gautham
  *
  * @retval None
  */
